        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="giftAction.action" role="button">Aqui</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="second-slide" src="" alt="img/sample.jpg">
          <div class="container">
            <div class="carousel-caption">
	...
	<hr class="featurette-divider">
      ...
      <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          <h2 class="featurette-heading">Ajude a Registrar Esse Momento. <span class="text-muted">#Julie&Bruno</span></h2>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Bezerra Figueiredo, <span class="text-muted">LUNA</span></h2>
